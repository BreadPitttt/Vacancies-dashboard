...
PARSERS={"parse_generic":parse_generic,"parse_seed":parse_seed}
...
def main():
    ...
    transp={"schemaVersion":"1.3","runMode":RUN_MODE,"totalListings":len(collected),"sourcesTried":used,"lastUpdated":datetime.utcnow().isoformat()+"Z"}
