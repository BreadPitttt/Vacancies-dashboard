# scraper.py — modernized: stable IDs, explicit decoding, shorter timeouts, per-source cap, 8-thread detail fetch
...
def fetch(url, timeout):
  r = HTTP.get(url, timeout=timeout)  # tuple timeouts for connect/read
  r.raise_for_status()
  return r
